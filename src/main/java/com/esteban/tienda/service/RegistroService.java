...
public class RegistroService {
    ...
    public Model activar(Model model, String username, String clave) {
        ...
        Optional<Usuario> usuario =
                usuarioService.getUsuarioPorUsernameYPassword(
                        username,
                        clave
                );
    ...
    public void activar(
        ...
        Usuario usuarioBD = usuarioService
                .getUsuario(usuarioFormulario.getIdUsuario())
                .orElseThrow(() ->
                        new IllegalArgumentException(
                                "No se encontró el usuario a activar."
                        )
                );

        usuarioBD.setUsername(
                usuarioFormulario.getUsername()
        );

        usuarioBD.setNombre(
                usuarioFormulario.getNombre()
        );

        usuarioBD.setApellidos(
                usuarioFormulario.getApellidos()
        );
        ...
        usuarioBD.setTelefono(
                usuarioFormulario.getTelefono()
        );

        usuarioBD.setPassword(
                usuarioFormulario.getPassword()
        );
    ...
    public Model crearUsuario(
            Model model,
            Usuario usuario) throws MessagingException {
    ...
    private void enviaCorreoActivar(
            Usuario usuario,
            String clave) throws MessagingException {
